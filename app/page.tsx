      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        <div className={style.shape}>
         ...
         <p className={` ${lusitana.className} text-xl text-white md:text-3xl md:leading-normal`}>
            ...
            <a href="https://nextjs.org/learn/" className="text-violet-400">
          ...
          <Link
            href="/login"
            className="flex items-center gap-5 self-start rounded-lg bg-violet-600 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-violet-500 md:text-base"
          >
