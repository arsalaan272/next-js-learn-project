...
export function UpdateInvoice({ id }: { id: string }) {
  return (
    <Link
      ...
      className="rounded-md border border-gray-700 p-2 text-gray-400 hover:bg-gray-800 hover:text-violet-400"
    >
...
export function DeleteInvoice({ id }: { id: string }) {
  return (
    <>
      <button type="submit" className="rounded-md border border-gray-700 p-2 text-gray-400 hover:bg-gray-800 hover:text-violet-400">
